...
if($_POST['status']){ //プレビュー
	...
	$img_path[$i] = search_file_disp($img."../../shopping/product_img/",$fetch[0]["PRODUCT_ID"]."_".$i.".*","",2);
}
...
// 前ページへのリンク
$pr = "<a href=\"./?pid=".$prev."\" class=\"pull_left w23\"><img src=\"images/prev.png\" alt=\"前へ\"></a>";
if(!$prev){
	$pr = "";
}

//次ページリンク
$nx = "<a href=\"./?pid=".$next."\" class=\"pull_right w23\"><img src=\"images/next.png\" alt=\"次へ\"></a>";
if(!$next){
	$nx = "";
}
