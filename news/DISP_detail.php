...
<html lang="ja">
    <head>
        <meta charset="utf-8">
        <title><?php echo $fetch[0]['TITLE']?$fetch[0]['TITLE']."｜":"";?>新着情報｜千葉県優良県産品の焼きのり谷海苔店。お歳暮、お中元、ギフト、仏事にどうぞ。</title>
        <meta name="description" content="<?php echo $fetch[0]['TITLE']?$fetch[0]['TITLE']."｜":"";?>株式会社谷海苔店の最新情報の詳細をご紹介します。弊社は千葉県優良県産品に選ばれたの焼きのりを皆様にお届けします。お歳暮、お中元、ギフト、仏事の際には弊社の海苔を是非ご利用ください。">
        <meta name="keywords" content="<?php echo $fetch[0]['TITLE']?$fetch[0]['TITLE'].",":"";?>谷海苔店,千葉,海苔,のり,焼きのり,お歳暮,お中元,優良県産品">
                ...
                <section class="container">
                    <div class="header_content clearfix">
                        ...
                        <div class="head_infor">
                            <h1 class="SEO"><?php echo $fetch[0]['TITLE']?$fetch[0]['TITLE']."｜":"";?>新着情報｜谷海苔店は千葉県優良県産品の焼きのりをお届けします。お歳暮、お中元、ギフト、仏事にどうぞ。</h1>
                            <?php echo DispHeader();?>
                        </div>
                    </div>
                </section>
